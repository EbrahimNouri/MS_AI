...
bootcamp_path = "../../../../karvand-manager/data/karvands.json"
report_path = "../../../../karvand-manager/data/report.json"
...
class Report:
    def __init__(self, karvands: list):
        ...
        if all_of_skills:
            self.average_skills = sum(skill.score for skill in all_of_skills) / len(
                all_of_skills
            )
        else:
